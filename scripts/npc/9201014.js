...
// 🎁 Premios para Onyx Chest (normal)
var cmPrizes = [
    [2000005, 100],   // Power Elixirs
    [2049100, 1],     // Chaos Scroll 60%
    [2340000, 3],     // White Scroll
    [3010007, 1],     // Red Relaxer Chair
    [1032026, 1]      // Gold Emerald Earrings
];

// 💍 Premios para Onyx Chest for Bride and Groom
var bgPrizes = [
    [2022179, 10],    // Elixir especial
    [2049301, 1],     // Equip Scroll
    [1102041, 1],     // Wedding Cape
    [3010013, 1],     // Love Chair
    [5150040, 5]      // VIP Hair Coupons
];
...
function action(mode, type, selection) {
    ...
    if (marriageRoom) {
        ...
        if (marriageAction == 2) {     // unclaimed gifts
            ...
            if (status == 0) {
                var msg = "Hello! I exchange Onyx Chests for rewards:\r\n#b";
